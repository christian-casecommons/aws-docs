...
- `config_application_image` - specifies the Docker image used to run the Intake API application containers.  Notice this matches the [image we created earlier]({{< relref "intake-api-stack/index.md#creating-the-intake-api-image" >}})
...
- `config_es_image` - specifies the Docker image used to run the Intake API Elasticsearch containers.  Notice this matches the [image we created earlier]({{< relref "intake-api-stack/index.md#creating-an-elasticsearch-image" >}})
...
- `config_cfn_lambda_kms_decrypt_version` - the S3 object version of the KMS decrypt Lambda function used for KMS decrypt custom resources.  Notice the object version matches [the version we published earlier]({{< relref "intake-api-stack/index.md#creating-lambda-functions" >}}).
- `config_cfn_lambda_ecs_tasks_version` - the S3 object version of the ECS tasks Lambda function used for ECS task custom resources.  Notice the object version matches [the version we published earlier]({{< relref "intake-api-stack/index.md#creating-lambda-functions" >}}).
